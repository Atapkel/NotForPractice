...
@Composable
fun CountryPage(
    countries: List<Country>, navController: NavHostController,
                ...
                TextField(
                    ...
                    onValueChange = { value ->
                        ...
                        filteredCountries = if (value.isEmpty()) {
                            ...
                            countries.filter { it.country.startsWith(value, ignoreCase = true) }
                        }
                    },
                    placeholder = {
                    ...
                    Row(
                        modifier = Modifier
                            ...
                            .clickable {
                                ...
                                viewModel.setSelectedCountry(country.country)
                                viewModel.setSelectedCountryId(country.id)
                                navController.popBackStack()
                            }
                            .background(
                                if (selectedCountry == country.country) Color(0x4DB5B5C9) else
                                    Color.White
                            )
                    ) {
                        Text(
